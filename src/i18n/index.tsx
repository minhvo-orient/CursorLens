...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "shortcut.seekForward": "Seek Forward",
    "shortcut.seekBackward": "Seek Backward",
    "shortcut.seekFine": "Fine Seek (±1s)",
    "shortcut.speedUp": "Speed Up",
    "shortcut.speedDown": "Speed Down",
    "shortcut.zoomIn": "Zoom In Timeline",
    "shortcut.zoomOut": "Zoom Out Timeline",
    "settings.seekStep": "Seek Step",
    "playback.previewSpeed": "Preview Speed",
    "playback.timelineZoom": "Timeline Zoom",
    "playback.fullscreen": "Fullscreen",
    "playback.exitFullscreen": "Exit Fullscreen",
    "shortcut.fullscreen": "Fullscreen",
    "shortcut.undo": "Undo",
    "shortcut.redo": "Redo",
    "shortcut.toggleScissors": "Split Mode",
    "shortcut.customize": "Customize",
    "shortcut.configTitle": "Keyboard Shortcuts",
    "shortcut.configurable": "Configurable",
    "shortcut.fixed": "Fixed",
    "shortcut.pressKey": "Press a key…",
    "shortcut.saved": "Shortcuts saved",
    "shortcut.resetDefaults": "Reset to defaults",
    "shortcut.resetHint": "Reset to defaults — click Save to apply",
    "shortcut.conflictFixed": "This key is already used by \"{{label}}\" and cannot be changed",
    "shortcut.conflictWith": "Already used by \"{{label}}\"",
    "shortcut.swap": "Swap",
  ...
  "zh-CN": {
    ...
    "shortcut.seekFine": "微调 (±1s)",
    "shortcut.speedUp": "加速播放",
    "shortcut.speedDown": "减速播放",
    "shortcut.zoomIn": "放大时间轴",
    "shortcut.zoomOut": "缩小时间轴",
    "settings.seekStep": "快进步长",
    "playback.previewSpeed": "预览速度",
    "playback.timelineZoom": "时间轴缩放",
    "playback.fullscreen": "全屏",
    "playback.exitFullscreen": "退出全屏",
    "shortcut.fullscreen": "全屏预览",
    "shortcut.undo": "撤销",
    "shortcut.redo": "重做",
    "shortcut.toggleScissors": "切割模式",
    "shortcut.customize": "自定义",
    "shortcut.configTitle": "快捷键设置",
    "shortcut.configurable": "可配置",
    "shortcut.fixed": "固定",
    "shortcut.pressKey": "按下按键…",
    "shortcut.saved": "快捷键已保存",
    "shortcut.resetDefaults": "重置为默认",
    "shortcut.resetHint": "已重置为默认快捷键 - 点击保存以应用",
    "shortcut.conflictFixed": "该快捷键已被「{{label}}」占用，无法更改",
    "shortcut.conflictWith": "已被「{{label}}」使用",
    "shortcut.swap": "交换",
